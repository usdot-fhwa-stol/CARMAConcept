...
public interface ILogger {
    ...
    public final static String TAG_SPEEDFILE ="SPD";

    /**
     * Log a message at logger.LogEntry.Level#DATA level.
     *
    ...
    /**
     * Log a message at logger.LogEntry.Level#DATA level. Formats the message much
    ...
    /**
     * Log a message at logger.LogEntry.Level#DEBUG level.
     * @param tag A string representing the category of the data
    ...
    /**
     * Log a message at logger.LogEntry.Level#ERROR level.
     * @param tag A string representing the category of the data
     * @param message A string containing a message to be logged
     * @return A reference to the generated log entry
     */
    ...
    /**
     * Log a message at logger.LogEntry.Level#WARN level.
     * @param tag A string representing the category of the data
     * @param message A string containing a message to be logged
     * @return A reference to the generated log entry
     */
